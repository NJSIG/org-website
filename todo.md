...
- [ ] Implement MongoDB CSFLE for form submissions
- [ ] Implement MongoDB watch streams or token based access by email
...
- [ ] Event mailing lists
- [ ] Length counter for text fields in admin panel
...
- [x] Look into JSON fields for tracking media usage with beforeChange and beforeDelete hooks
